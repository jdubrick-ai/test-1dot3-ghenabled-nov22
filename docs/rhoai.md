...
3) Access the `workbench` named `test-1dot3-ghenabled-nov22-notebook`.
...
5) In the terminal, run `cd test-1dot3-ghenabled-nov22` to navigate to your sample app's directory.
